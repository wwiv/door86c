...
std::vector<op_code_data_t> create_opcode_metadata() {
  std::vector<op_code_data_t> v{
      // First Octet
          ...
          {0x06, op_mask_notimpl, "PUSH ES"},
          {0x07, op_mask_notimpl, "POP ES"},
          // Next Octet
          ...
          {0x85, op_mask_notimpl | op_mask_modrm16, ""},
          ...
          {0xD0, op_mask_notimpl | op_mask_modrm8, ""},
          {0xD1, op_mask_notimpl | op_mask_modrm16, ""},
          {0xD2, op_mask_notimpl | op_mask_modrm8, ""},
          {0xD3, op_mask_notimpl | op_mask_modrm16, ""},
          ...
          {0xE3, op_mask_notimpl | op_mask_imm8, "JCXZ"},
